...
public class DocumentResourceIT {
    ...
    private static final Instant DEFAULT_DATE_DOC = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_DOC = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final String DEFAULT_LINK_DOC = "AAAAAAAAAA";
    private static final String UPDATED_LINK_DOC = "BBBBBBBBBB";

    private static final TypeDocument DEFAULT_TYPE_DOC = TypeDocument.PHOTOS;
    private static final TypeDocument UPDATED_TYPE_DOC = TypeDocument.PHOTOSPROFIL;
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getDocTitle()).isEqualTo(DEFAULT_DOC_TITLE);
        assertThat(testDocument.getDateDoc()).isEqualTo(DEFAULT_DATE_DOC);
        assertThat(testDocument.getLinkDoc()).isEqualTo(DEFAULT_LINK_DOC);
        assertThat(testDocument.getTypeDoc()).isEqualTo(DEFAULT_TYPE_DOC);
    }
    ...
    @Test
    @Transactional
    public void checkDocTitleIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
        document.setDocTitle(null);
    ...
    @Test
    @Transactional
    public void checkTypeDocIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
    ...
    public void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateDoc").value(hasItem(DEFAULT_DATE_DOC.toString())))
            .andExpect(jsonPath("$.[*].linkDoc").value(hasItem(DEFAULT_LINK_DOC)))
            .andExpect(jsonPath("$.[*].typeDoc").value(hasItem(DEFAULT_TYPE_DOC.toString())));
    }
    ...
    public void getDocument() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents/{id}", document.getId()))
            ...
            .andExpect(jsonPath("$.dateDoc").value(DEFAULT_DATE_DOC.toString()))
            .andExpect(jsonPath("$.linkDoc").value(DEFAULT_LINK_DOC))
            .andExpect(jsonPath("$.typeDoc").value(DEFAULT_TYPE_DOC.toString()));
    }
    ...
    public void updateDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getDocTitle()).isEqualTo(UPDATED_DOC_TITLE);
        assertThat(testDocument.getDateDoc()).isEqualTo(UPDATED_DATE_DOC);
        assertThat(testDocument.getLinkDoc()).isEqualTo(UPDATED_LINK_DOC);
        assertThat(testDocument.getTypeDoc()).isEqualTo(UPDATED_TYPE_DOC);
    }
