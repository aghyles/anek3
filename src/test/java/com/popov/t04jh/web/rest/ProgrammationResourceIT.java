...
public class ProgrammationResourceIT {
    ...
    private static final Long DEFAULT_ID_GROUPE = 1L;
    private static final Long UPDATED_ID_GROUPE = 2L;
    ...
    public void createProgrammation() throws Exception {
        ...
        assertThat(testProgrammation.getIdGroupe()).isEqualTo(DEFAULT_ID_GROUPE);
    }
    ...
    @Test
    @Transactional
    public void checkIdGroupeIsRequired() throws Exception {
        int databaseSizeBeforeTest = programmationRepository.findAll().size();
        // set the field null
        programmation.setIdGroupe(null);
    ...
    public void getAllProgrammations() throws Exception {
        ...
        restProgrammationMockMvc.perform(get("/api/programmations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idGroupe").value(hasItem(DEFAULT_ID_GROUPE.intValue())));
    }
    ...
    public void getProgrammation() throws Exception {
        ...
        restProgrammationMockMvc.perform(get("/api/programmations/{id}", programmation.getId()))
            ...
            .andExpect(jsonPath("$.idGroupe").value(DEFAULT_ID_GROUPE.intValue()));
    }
    ...
    public void updateProgrammation() throws Exception {
        ...
        assertThat(testProgrammation.getIdGroupe()).isEqualTo(UPDATED_ID_GROUPE);
    }
