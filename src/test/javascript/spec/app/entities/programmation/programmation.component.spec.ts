...
import { ProgrammationComponent } from 'app/entities/programmation/programmation.component';
...
describe('Component Tests', () => {
  describe('Programmation Management Component', () => {
    let comp: ProgrammationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProgrammationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.programmations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
