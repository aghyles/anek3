...
import { PresenceComponent } from 'app/entities/presence/presence.component';
...
describe('Component Tests', () => {
  describe('Presence Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.presences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
