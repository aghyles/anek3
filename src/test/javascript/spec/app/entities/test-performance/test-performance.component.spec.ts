...
import { TestPerformanceComponent } from 'app/entities/test-performance/test-performance.component';
...
describe('Component Tests', () => {
  describe('TestPerformance Management Component', () => {
    let comp: TestPerformanceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TestPerformanceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.testPerformances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
