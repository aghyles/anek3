...
import { CalendarEvent, CalendarEventAction, CalendarEventTimesChangedEvent, CalendarMonthViewDay,DAYS_OF_WEEK } from 'angular-calendar';
...
export class CalendarComponent implements OnInit
{
    ...
    weekendDays: number[] = [DAYS_OF_WEEK.FRIDAY, DAYS_OF_WEEK.FRIDAY];
