...
export class ObjectifComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.objectifService
      ...
      .subscribe((res: HttpResponse<IObjectif[]>) => this.paginateObjectifs(res.body, res.headers));
  }
  ...
  registerChangeInObjectifs() {
    this.eventSubscriber = this.eventManager.subscribe('objectifListModification', () => this.loadAll());
  }

  delete(objectif: IObjectif) {
  ...
  protected paginateObjectifs(data: IObjectif[], headers: HttpHeaders) {
