...
export class PresenceComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.presenceService
      ...
      .subscribe((res: HttpResponse<IPresence[]>) => this.paginatePresences(res.body, res.headers));
  }
  ...
  registerChangeInPresences() {
    this.eventSubscriber = this.eventManager.subscribe('presenceListModification', () => this.loadAll());
  }

  delete(presence: IPresence) {
  ...
  protected paginatePresences(data: IPresence[], headers: HttpHeaders) {
